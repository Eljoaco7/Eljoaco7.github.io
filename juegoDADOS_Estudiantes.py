...
imagenes_dados = [pygame.image.load(f"C:/Users/User/Desktop/imagenes/imagenes/dados/dado{i}.png") for i in range(1, 7)]
...
def evaluar_ronda():
    ...
    if jugador_suma > 10 and cpu_suma > 10:
        resultado = "Ambos se pasaron y empataron"
    elif  jugador_suma > 10:
        resultado = "Te pasaste y gano la cpu"
    elif cpu_suma > 10:
      resultado = "Se paso la cpu y gano el jugador"
    elif  jugador_suma > cpu_suma:
        resultado = "Gana el jugador"
    elif  cpu_suma > jugador_suma:
        resultado = "Gana la cpu"
    elif jugador_suma == cpu_suma:
        resultado = "Empataron los dos"
